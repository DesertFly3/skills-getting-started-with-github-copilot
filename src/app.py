...
def build_initial_activities():
    """Return a fresh copy of the in-memory activity data."""
    return {
        "Chess Club": {
        ...
        "Soccer Club": {
            "description": "Play soccer and develop your athletic skills",
...
activities = build_initial_activities()
